...
| :---: | :---: |
| ![Tableau Treemap Popular Artists](EDA/Popular_Artists.PNG) | ![SQL Artist Verification Grid](Spotify_EDA_in_SQL/Popular_Artists.PNG) |
...
| :---: | :---: |
| ![Tableau Popular Genres](EDA/Popular_Genres.PNG) | ![SQL Genre Verification Grid](Spotify_EDA_in_SQL/Popular_Genres.PNG) |
...
| :---: | :---: |
| ![Tableau Mood Trends](EDA/Mood_Trends.PNG) | ![SQL Mood Trends Grid](Spotify_EDA_in_SQL/Mood_Trends.PNG) |
...
| :---: | :---: |
| ![Tableau Audio Profiling Matrix](EDA/Audio_Feature.PNG) | ![SQL Audio Features Grid](Spotify_EDA_in_SQL/Audio_Featuring.PNG) |
...
| :---: | :---: |
| ![Tableau Explicit Content Impact](EDA/Explicit_and_Clean_Content.PNG) | ![SQL Explicit Content Grid](Spotify_EDA_in_SQL/Explicit_Content.PNG) |
